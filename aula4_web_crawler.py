# -*- coding: utf-8 -*-
"""aula4_web_crawler.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14GN-ZMvHNLxK5HDRJB1n0CN8IKVoobg5
"""
...
for page in pages:
  response = get('https://www.imdb.com/search/title/?title_type=movie&genres=sci-fi&start=' + str(page) + '&explore=title_type,genres&ref_=adv_nxt', headers=headers)
...
for container in movie_containers:
  if container.find('div', class_='rating-metascore') is not None:
    ...
    titles.append(title) #append inclui mais informação na variavel
